...
try {
    switch ($action) {
        ...
        case 'resume':
            ...
            // Verify this queue belongs to this counter and is stalled or skipped
            $verifyStmt = $conn->prepare("
            ...
            $resumeStmt->bind_param("si", $studentId, $queueId);
            $resumeStmt->execute();
            $resumeStmt->close();
            
            logQueueAction($conn, $queueId, 'resumed', "Resumed by worker at counter $counterNumber");
